 ...
 * real rather than from a sample; then prefer exact recipes over substituted ones; then prefer
 * voices whose author listed the role first; then avoid leaving a box switched on and unused.
 *
