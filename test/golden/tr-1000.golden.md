...
**Clock master** — TR-1000 over `midi-din`, carrying 5 parts. Slave everything else to it.
...
- **GEN** `909 Bass Drum` · ⚠ provisional — nobody has checked this value
  - ↳ hint: Hold [SHIFT]+[GEN], select with [C6]
- **PITCH** `-12` % (-100…100 %) · ⚠ provisional — nobody has checked this value
  - ↳ cite: range manual — TR-1000 Reference Manual (eng02) v1.13+, p.59
  - ↳ hint: Tuning; TUNE is the pitch envelope
- **DECAY** `32` % (0…100 %) · ⚠ provisional — nobody has checked this value
  - ↳ cite: range manual — TR-1000 Reference Manual (eng02) v1.13+, p.59
- **TUNE** `30` % (-100…100 %) · ⚠ provisional — nobody has checked this value
  - ↳ cite: range manual — TR-1000 Reference Manual (eng02) v1.13+, p.59
  - ↳ hint: Pitch-envelope intensity, not tuning
- **ATTACK** `74` % (0…100 %) · ⚠ provisional — nobody has checked this value
  - ↳ cite: range manual — TR-1000 Reference Manual (eng02) v1.13+, p.59
