...
describe('trigger notes: read for, and declined (§2.1/#334)', () => {
   ...
   * seeds 1-6.
   *
   * 354 is the figure for this device and none of it is a gap to close. The number moves when a
   * direction gains or loses a part or this box gains a recipe — #334 measured 216, #345 made it
   * 246, Hard Techno 288, Drum and Bass 354 from the 324 pinned before it, by asking for five
   * drum parts this box carries: kick, snare, closed hat, open hat and ghost perc — and a diff is a prompt
  ...
  it('leaves 354 grid parts blank, and pins how many there are', () => {
    ...
    // 240 until #345 authored `rim`, `ride` and `noise`; 270 until Hard Techno; 354 until Drum
    // and Bass.
