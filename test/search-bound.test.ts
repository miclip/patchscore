...
describe('the bound, direction by direction (§7.1/#159)', () => {
  ...
  const RECORDED: Record<string, readonly number[]> = {
    ...
    // 583,511 -> 586,551 at its peak and `lydian-house` up across the board, while `weave` seed
    ...
    'lydian-house': [
      ...
      1371, 1371, 315, 1358, 235, 723, 314, 6906, 236
    ],
    'major-key-electro': [
      446, 243, 242, 549, 243, 243, 242, 243, 444, 240, 444, 243, 237, 240, 243, 241, 243, 242,
