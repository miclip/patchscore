...
describe('the bound, direction by direction (§7.1/#159)', () => {
  ...
  const RECORDED: Record<string, readonly number[]> = {
    ...
    'ambient-dub': [
      271, 641, 275, 467, 647, 273, 275, 461, 280, 277, 275, 493, 275, 280, 274, 271, 466, 277,
      1116, 638, 279, 278, 271, 275
    ],
    'breakbeat': [
    ...
    'industrial-techno': [
      504078, 509638, 505881, 508446, 511254, 504080, 508870, 505272, 508234, 502855, 543763,
      505272, 506974, 502854, 509644, 505214, 502855, 552317, 583511, 508732, 502855, 508139,
      504080, 505881
    ],
    'lydian-house': [
      235, 1258, 1140, 1156, 1157, 403, 1141, 402, 1157, 1371, 234, 402, 1141, 723, 315, 1371,
      1371, 315, 1358, 235, 723, 235, 1250, 236
    ],
    'major-key-electro': [
      446, 243, 241, 1474, 243, 243, 242, 243, 444, 240, 243, 243, 237, 240, 243, 240, 243, 242,
      243, 239, 243, 240, 243, 242
    ],
    'relay': [
