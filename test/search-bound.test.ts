...
describe('the bound, direction by direction (§7.1/#159)', () => {
  ...
  const RECORDED: Record<string, readonly number[]> = {
    ...
    'ambient-dub': [
      339, 422, 347, 1264, 522, 1080, 347, 1247, 353, 259, 1143, 391, 349, 262, 345, 253, 398, 351,
      555, 515, 261, 355, 253, 343
    ],
    'breakbeat': [
    ...
    'generative-drift': [
      468, 234, 706, 2840, 828, 2837, 706, 2837, 624, 322, 2958, 234, 617, 325, 294, 322, 234, 294,
      322, 617, 236, 617, 322, 624
    ],
