...
describe('the bound, direction by direction (§7.1/#159)', () => {
  ...
  const RECORDED: Record<string, readonly number[]> = {
    ...
    'ambient-dub': [
      267, 628, 271, 460, 634, 269, 271, 454, 276, 273, 271, 486, 271, 276, 270, 267, 459, 273,
      1097, 625, 275, 274, 267, 271
    ],
    'breakbeat': [
    ...
    'generative-drift': [
      597, 241, 918, 243, 875, 241, 918, 241, 655, 369, 838, 241, 648, 373, 306, 403, 241, 306, 403,
      648, 243, 648, 403, 655
    ],
    ...
    'industrial-techno': [
      503808, 509369, 505611, 508177, 510984, 503812, 508600, 505004, 507964, 502588, 543493,
      505004, 506704, 502587, 509372, 504946, 502588, 552045, 583115, 508462, 502588, 507869,
      503812, 505611
    ],
    'lydian-house': [
