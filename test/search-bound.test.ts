...
describe('the bound, direction by direction (§7.1/#159)', () => {
  ...
  const RECORDED: Record<string, readonly number[]> = {
    ...
    'industrial-techno': [
      503943, 509505, 505746, 508312, 511119, 503947, 508735, 505139, 508099, 502722, 543629,
      505139, 506839, 502721, 509509, 505080, 502722, 552181, 583313, 508598, 502722, 508005,
      503946, 505747
    ],
    'lydian-house': [
      234, 1257, 1139, 1155, 1156, 402, 1140, 401, 1156, 1370, 233, 401, 1140, 722, 314, 1370,
      1370, 314, 1357, 234, 722, 234, 1249, 235
    ],
    'major-key-electro': [
