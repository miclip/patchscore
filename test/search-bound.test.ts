...
describe('the bound, direction by direction (§7.1/#159)', () => {
  ...
  const RECORDED: Record<string, readonly number[]> = {
    'acid-lineage': [
      243, 153, 154, 153, 154, 153, 154, 153, 243, 152, 153, 153, 153, 152, 154, 152, 153, 153, 152,
      153, 153, 153, 153, 154
    ],
    'ambient-dub': [
      332, 411, 340, 1218, 509, 1038, 340, 1201, 346, 254, 1099, 382, 342, 257, 338, 248, 389, 344,
      540, 502, 256, 348, 248, 336
    ],
    'breakbeat': [
    ...
    'generative-drift': [
      455, 229, 686, 2707, 804, 2704, 686, 2704, 607, 314, 2832, 229, 600, 317, 287, 314, 229, 287,
      314, 600, 231, 600, 314, 607
    ],
    ...
    'industrial-techno': [
      490095, 495510, 491849, 494348, 497083, 490099, 494759, 491261, 494142, 488910, 528718,
      491261, 492912, 488909, 495513, 491203, 488910, 537045, 566908, 494621, 488910, 494047,
      490099, 491849
    ],
    'lydian-house': [
    ...
    'major-key-electro': [
      426, 233, 231, 1357, 233, 233, 232, 233, 424, 230, 233, 233, 227, 230, 233, 230, 233, 232,
      233, 229, 233, 230, 233, 232
    ],
    'relay': [
