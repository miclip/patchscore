...
describe('the bound, direction by direction (§7.1/#159)', () => {
  ...
  const RECORDED: Record<string, readonly number[]> = {
    ...
    'ambient-dub': [
      346, 433, 354, 1316, 534, 1128, 354, 1299, 360, 265, 1192, 401, 356, 268, 352, 259, 408, 358,
      570, 527, 267, 362, 259, 350
    ],
    'breakbeat': [
    ...
    'industrial-techno': [
      503804, 509363, 505607, 508171, 510980, 503808, 508596, 505000, 507960, 502586, 543489,
      505000, 506700, 502585, 509366, 504942, 502586, 552039, 582919, 508458, 502586, 507865,
      503808, 505607
    ],
    'lydian-house': [
    ...
    'weave': [
      249, 352, 1435, 623, 289, 352, 1435, 290, 371, 1315, 25357, 290, 373, 1315, 254, 286, 352,
      10658, 25938, 589, 539, 497, 254, 254
    ],
  }
