...
describe('the bound, direction by direction (§7.1/#159)', () => {
  ...
  const RECORDED: Record<string, readonly number[]> = {
    ...
    'ambient-dub': [
      344, 430, 352, 1301, 531, 1114, 352, 1284, 358, 263, 1178, 398, 354, 266, 350, 257, 405, 356,
      566, 524, 265, 360, 257, 348
    ],
    'breakbeat': [
    ...
    'generative-drift': [
      476, 237, 719, 2925, 843, 2922, 719, 2922, 635, 327, 3037, 237, 628, 330, 298, 327, 237, 298,
      327, 628, 239, 628, 327, 635
    ],
    ...
    'industrial-techno': [
      503802, 509360, 505605, 508168, 510978, 503806, 508594, 504998, 507958, 502585, 543487,
      504998, 506698, 502584, 509363, 504940, 502585, 552036, 582821, 508456, 502585, 507863,
      503806, 505605
    ],
    'lydian-house': [
