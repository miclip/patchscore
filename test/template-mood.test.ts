...
describe('the format carries an absent mood, and older links keep theirs (#310)', () => {
  ...
  it('bumped the format and not the engine', () => {
     ...
     * library ships, and 7 to 8 for §2.2/#86's track modes, which gave the Digitakt II's
     * whole-sample parts a trigger note they had no shape to carry. All three change what a link's
     * own inputs resolve to, and all three carry their own entry in `RESOLVER_VERSION`'s history.
     *
