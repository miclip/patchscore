    ...
    <main className="shell catalogue-page">
      <header className="masthead">
        ...
        {/*
          ...
          **"Off a manual or off the box itself", because a manual is not the only source.** The
          first draft said every setting is read off the manual, which is the common case and not
          the claim: a preset session's `observed` reading is a list somebody who owns the box
          picked out at the box, and the Muse's patches are there because a person sat in front of
          one. Narrowing the claim to manuals would have made it false about real content on this
          site in the direction that matters — overstating what has been checked.
        */}
        <p>
          Nothing here is generated by a language model. Every setting was read off a manual or
          off the box itself, and anything that has not been is marked as unverified rather than
          filled in.
        </p>
      </header>
